 ...
 */
public class ModularArithmeticsI extends AbstractTestCase {

	@XMLParameter(defaultValue = "1000")
	public int argBase;
	
	// cntModules = 3;
	public int mod_0 = 13, mod_1 = 16, mod_2 = 47;
	public int  /*not def */   modInverse_01, modInverse_02,
				modInverse_10,  /*not def */  modInverse_12,
				modInverse_20, modInverse_21  /*not def */ ;
	
	public int modMult;
	public int modMultExt_0, modMultExt_1, modMultExt_2;
	
	// cntOperands = 4;
	private int operand_0, operand_1, operand_2, operand_3; 
	private int 	operandRem_00, operandRem_01, operandRem_02,
	...
	private int resRem_0, resRem_1, resRem_2;
	...
	public long iteration() {
		...
		for (int it = 0; it < repeats; it++) {
			...
			int result = calcFast(resRem_0, resRem_1, resRem_2);
			
			if(config.isValidating) {
				long error = result - (1L * operand_0 * operand_1 - 1L * operand_2 * operand_3);
				if (error % modMult != 0) {
	...
	public int calcFast(int r0, int r1, int r2) {
