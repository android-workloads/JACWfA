...
/**
 * <p>
 * Test applies a median filter. Typically used to reduce the amount of noise in
 * the image
 * </p>
 * 
 */
public class BlurMedian extends AbstractTestCase {

	@XMLParameter(defaultValue = "sample_picture.jpg")
	protected String goldenFileName;
	...
	public long iteration() {
		...
		for (int i = 0; i < repeats; i++) {
			BlurImageOps.median(image, blurred, 5);
			count++;
		}
		return count;
