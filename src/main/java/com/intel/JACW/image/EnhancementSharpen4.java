...
/**
 * <p>
 * Test performs intensity modification with sharpen4 function.
 * </p>
 * <p>
 * Test uses sharpen-4 function, which increase intensity of edges but the other
 * parts stay the same. It's usually used to processing images in mobile
 * applications
 * </p>
 * 
 */
public class EnhancementSharpen4 extends AbstractTestCase {
	...
	public long iteration() {
		...
		for (int i = 0; i < repeats; i++) {
			EnhanceImageOps.sharpen4(image, result);
			count++;
		}
		return count;
	}
