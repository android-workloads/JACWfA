...
/**
 * <p>
 * Test performs image denoising using Bayes algorithm
 * </p>
 * <p>
 * It uses wavelet based bayes algorithm to add and remove noise from image.
 * Often noise is modeled as Gaussian noise being added to each pixel
 * independently. And finally filter creates a smoother image. Commonly used in
 * image processing.
 * </p>
 * 
 */
public class DenoiseBayes extends AbstractTestCase {

	@XMLParameter(defaultValue = "sample_picture.jpg")
	public String goldenFileName;

	private ImageFloat32 noisy, denoisy;
	private Random rnd;
	private int levels;
