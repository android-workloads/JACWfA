...
/**
 * Introsort algorithm which uses combination of Quick and Heap sorts.
 * 
 * It performs recursive operation of qsort algorithm on the depth at most of log(array length). 
 * Next it switches on heap sort. 
 * 
 */
public class IntroSortHeap extends AbstractTestCase {
