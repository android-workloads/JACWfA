...
/**
 * Recursive Qsort implementation for [integer] arrays.
 * 
 ...
 * 
 * 
 * @see com.intel.JACW.sort.QSortIterativeI
 */
public class QSortRecursiveI extends AbstractTestCase {
	 ...
	 * @param array
	 *            array to sort
	 * @return number of int operations
	 */
	public void qsort(int[] array) {
		qsortRecursiveUnwrapped(array, 0, array.length - 1);
	}

	private void qsortRecursiveUnwrapped(int[] array, int left, int right) {
		if (left < right) {
