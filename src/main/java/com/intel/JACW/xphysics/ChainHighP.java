...
/**
 * Movement of chained objects with high position precisely.
 * 
 * Test uses high position iterations on world update in step()
 *  
 */
public class ChainHighP extends AbstractTestCase {
