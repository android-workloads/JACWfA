...
/**
 * Movement of chained objects with high velocity precisely.
 * Test uses high velocity iterations on world update in step()
 * 
 */
public class ChainHighV extends AbstractTestCase {
